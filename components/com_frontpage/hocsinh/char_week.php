...
global $type_user;
if($filter_username=='')  $this_user_cur=getInfo('username');
else $this_user_cur=$filter_username;
...
$item = SysGetList("ez_member_time_visit",array(), " AND member='$this_user_cur' $strwhere",false);
$arr_value=$arr=array();
